...
from models import Professional, Customer, ServiceRequest, ServicePackage, RejectedServiceRequest, db
...
def search():
    if request.method == 'POST':
        ...
        service_request = (
                ...
                .filter_by(service_package_id=professional.service_package_id)  # Filter by service_package_id
                .join(Customer)  # Join with the Customer table
                .filter(Customer.city == city)  # Filter by city
                .first()
            )
